...
// go 1.26 platform-wide: the LiveKit SDK the consultation domain is built on
// (server-sdk-go/v2, protocol, mediatransportutil) declares go 1.26 in its own
// go.mod, so the minimum for the whole module is 1.26 -- not drift.
go 1.26
