...
('reschedule_requested', 'sms', 'ta', 'urgent', NULL,
...
('reschedule_requested', 'push', 'en', 'urgent', 'Visit time change requested',
 'Dr. {{.DoctorName}} asked to move {{.DateTime}} to {{.ProposedDateTime}}.'),
('reschedule_requested', 'push', 'si', 'urgent', 'හමුවේ වේලාව වෙනස් කිරීමට ඉල්ලීමක්',
 'වෛද්‍ය {{.DoctorName}} {{.DateTime}} හමුව {{.ProposedDateTime}} දක්වා වෙනස් කිරීමට ඉල්ලා ඇත.'),
('reschedule_requested', 'push', 'ta', 'urgent', 'சந்திப்பு நேரம் மாற்றக் கோரிக்கை',
 'மருத்துவர் {{.DoctorName}} {{.DateTime}} சந்திப்பை {{.ProposedDateTime}}க்கு மாற்றக் கேட்டுள்ளார்.'),

('reschedule_requested', 'email', 'en', 'urgent',
...
('reschedule_requested', 'email', 'si', 'urgent',
...
('reschedule_requested', 'email', 'ta', 'urgent',
...
('reschedule_requested', 'in_app', 'en', 'urgent', 'Visit time change requested',
 'Dr. {{.DoctorName}} asked to move your visit from {{.DateTime}} to {{.ProposedDateTime}}. Accept or decline (full refund).'),
('reschedule_requested', 'in_app', 'si', 'urgent', 'හමුවේ වේලාව වෙනස් කිරීමට ඉල්ලීමක්',
...
('reschedule_requested', 'in_app', 'ta', 'urgent', 'சந்திப்பு நேரம் மாற்றக் கோரிக்கை',
